...
-  A third state - *blocked*, will be helpful, to signal that some [[Computer Systems/Processes/File IO|File IO]] operation is in progress and it cannot run until the operation is completed
