...
### Process-Based
Using [[../Processes/Processes|processes]] with `fork()`:
```c
pid_t child = fork();
if (child == 0) {
    // Child process
...
### System Level
- [[../Processes/Processes|Processes]] - Process-based concurrency
...
### C Programming
- [[../C/C|C]] - Language features for concurrency
- [[../C/Pointers/Pointers|Pointers]] - Essential for shared memory
