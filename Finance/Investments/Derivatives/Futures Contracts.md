...
| Feature | Futures | [[Options\|Options]] |
|---------|---------|---------|
...
- [[Options|Options]] - Alternative derivative with no obligation
- [[Call Options|Call Options]] - Right to buy (vs obligation in futures)
- [[Put Options|Put Options]] - Right to sell (vs obligation in futures)
