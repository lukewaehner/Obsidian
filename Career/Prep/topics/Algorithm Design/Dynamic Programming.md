...
Each DP-soluble problem must be defined as a recursion relation, and finding
that relation is the hard part — worth recognizing a problem as a DP
...
[[Edit Distance and Sequence Alignment]], [[Space Optimization in DP]].

Compare against a greedy approach before committing to a DP formulation —
[[Greedy Algorithms]], [[Greedy vs Dynamic Programming]].
...
- [List of individual DP problems (playlist)](https://www.youtube.com/playlist?list=PLrmLmBdmIlpsHaNTPP_jHHDx_os9ItYXr)
- [Dynamic Programming (Yale notes)](http://www.cs.yale.edu/homes/aspnes/classes/223/notes.html#dynamicProgramming)
...
- [6.006: Dynamic Programming I: Fibonacci, Shortest Paths (video)](https://www.youtube.com/watch?v=r4-cftqTcdI&ab_channel=MITOpenCourseWare)
- [6.006: Dynamic Programming II: Text Justification, Blackjack (video)](https://www.youtube.com/watch?v=KLBCUx1is2c&ab_channel=MITOpenCourseWare)
- [6.006: DP III: Parenthesization, Edit Distance, Knapsack (video)](https://www.youtube.com/watch?v=TDo3r5M1LNo&ab_channel=MITOpenCourseWare)
- [6.006: DP IV: Guitar Fingering, Tetris, Super Mario Bros. (video)](https://www.youtube.com/watch?v=i9OAOk0CUQE&ab_channel=MITOpenCourseWare)
