...
Know about the most famous classes of NP-complete problems, such as the traveling
salesman and the knapsack problem, and be able to recognize them when an interviewer
asks you them in disguise. Know what NP-complete means.
...
- Peter Norvig discusses near-optimal solutions to the traveling salesman problem: [Jupyter Notebook](http://nbviewer.jupyter.org/url/norvig.com/ipython/TSP.ipynb)
