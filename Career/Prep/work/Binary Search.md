...
related:
  ...
  - '[[Career/Prep/work/Stack|Stack]]'
  - '[[Career/Prep/work/Queue|Queue]]'
---
# Binary Search
...
4. **Using on [[Career/Prep/work/Linked List|Linked List]]** - O(log n) comparisons but O(n) access time = O(n) overall
...
## Related Concepts
- [[Career/Prep/work/DSA|DSA]] - Main data structures & algorithms overview
