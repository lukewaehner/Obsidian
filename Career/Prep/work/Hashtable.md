...
related:
  - "[[Career/Prep/work/Binary Search|Binary Search]]"
  - "[[Career/Prep/work/Linked List|Linked List]]"
  - "[[Career/Prep/work/DSA|DSA]]"
---
# Hashtable (Hash Map)
...
## Implementation: Hash Map (Open Addressing / Linear Probing)
...
| [[Career/Prep/work/Binary Search|Binary Search]] (sorted array) | O(log n) | O(n) | O(n) | Yes |
| [[Career/Prep/work/Linked List|Linked List]] | O(n) | O(1) | O(1) | No |
...
## Related Concepts
- [[Career/Prep/work/DSA|DSA]] - Main data structures overview
- [[Career/Prep/work/Linked List|Linked List]] - Used in chaining approach
