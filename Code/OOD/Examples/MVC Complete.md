...
Class: [[OOD]]
Related: [[Model, View, and Controller]], [[Examples Index#Full MVC Implementation]]
...
public class MVCExampleTextUI {
  public static void main(String[] args) {
    ...
    IController controller = new TextController(model, view, System.in);
...
1. **Model** doesn't know about View or Controller
2. **View** doesn't know about Model or Controller
3. **Controller** orchestrates but doesn't implement business logic
4. Easy to swap any component (e.g., GUI view instead of text view)