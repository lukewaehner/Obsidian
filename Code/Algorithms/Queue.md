...
- Need LIFO (most recent first) → use [[Code/Algorithms/Stack|Stack]]
...
- [[Code/Algorithms/Stack|Stack]] - LIFO counterpart to queue's FIFO
- [[Linked List|Linked List]] - Can implement queue with linked list
- [[Doubly Linked List|Doubly Linked List]] - Used in `collections.deque`
