...
4. **Using on [[Linked List|Linked List]]** - O(log n) comparisons but O(n) access time = O(n) overall
...
## Related Concepts
- [[DSA|DSA]] - Main data structures & algorithms overview
