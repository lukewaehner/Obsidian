...
- Need LIFO (most recent first) → use [[Stack]]
...
- [[Stack]] - LIFO counterpart to queue's FIFO
- [[Linked List]] - Can implement queue with linked list
- [[Doubly Linked List]] - Used in `collections.deque`
